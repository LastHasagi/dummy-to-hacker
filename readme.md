...
```mermaid
gantt
    title Roadmap de 12 Meses - Do Zero ao Hacker
    dateFormat YYYY-MM
    section Mês 1-3 Fundamentos
    Fundamentos de Cybersecurity        :a1, 2024-01, 1M
    Linux e Command Line                :a2, after a1, 1M
    Ethical Hacking Básico              :a3, after a2, 1M
    section Mês 4-6 Prática
    Web Application Hacking             :b1, after a3, 1M
    Scripting (Python & Bash)           :b2, after b1, 1M
    Bug Bounty Hunting                  :b3, after b2, 1M
    section Mês 7-9 Certificações
    Certificações                       :c1, after b3, 1M
    Construir Portfólio                 :c2, after c1, 1M
    Networking e Estágios               :c3, after c2, 1M
    section Mês 10-12 Avançado
    Pentesting Avançado                 :d1, after c3, 1M
```
